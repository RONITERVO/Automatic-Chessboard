...
Firmware 3.29 adds versioned `INFO`/`TELEM` monitoring, persistent selectable
reed-sensor rank profiles, and a best-effort `!` remote halt checked inside
motion loops. Bluetooth and cameras are not safety
