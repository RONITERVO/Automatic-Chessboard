...
| 4 | STEP/DIR pull-down resistor | 10 kohm, 1/4 W; one independent resistor from each driver `STEP` and `DIR` input to logic GND | Four 10 kohm resistors installed and tested on the working prototype |
